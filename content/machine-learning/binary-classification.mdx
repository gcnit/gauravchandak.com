...
The choice of method depends on the problem and available data. [Any two optimization algorithms are equivalent when their performance is averaged across all possible problems. There is no free lunch.](https://en.wikipedia.org/wiki/No_free_lunch_theorem). It is [recommended](https://www.quora.com/What-are-the-advantages-of-different-classification-algorithms/answer/Xavier-Amatriain) to start with simpler methods and consider more complex ones if needed.
